...
export default {
    ...
    methods: {
        ...
        getIsConfirm(id) {
            var that = this;
            that.$http('get', that.$store.state.baseUrl + 'api/Task/user-apply?taskId=' + id + "&uid=" + that.$store.state.uid).then(function (res) {
        ...
        getEnrollBuss() {
            ...
            console.log(that.enmrollBussPostData)
            that.$http('get', that.$store.state.baseUrl + 'api/Task/Apply/List', that.enmrollBussPostData).then(function (res) {
                // console.log(res.data.data);
                if (res.data.code != '00') {
                    AlertModule.show({
                        title: res.data.msg
        ...
        getEnrollWriter() {
            ...
            console.log(that.enmrollWriterPostData)
            that.$http('get', that.$store.state.baseUrl + 'api/Task/Apply/List', that.enmrollWriterPostData).then(function (res) {
                // console.log(res.data.data);
                if (res.data.code != '00') {
                    AlertModule.show({
                        title: res.data.msg
