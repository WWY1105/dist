        ...
        <div class="mainContent" v-if="!canTalk">
            ...
            <div class="bgW brifMsg flexSpace">
                ...
                <div class="right">
                    ...
                    <p>{{taskObj.priceType=='1'?'1对1':'1对多'}} / {{taskObj.coordination=='online'?'线上沟通':taskObj.coordination=='author'?'家教上门':'家长拜访'}}</p>
                    <p>{{taskObj.area}}</p>
                </div>
            </div>
            ...
            <div class="eachBox bgW">
                ...
                <div class="content">
                    ...
                    <span class="mainText">￥{{taskObj.taskType=='3'?Math.floor(infoObj.price/(taskObj.busniessCount+1)*100)/100:Math.floor(infoObj.price/taskObj.busniessCount*100)/100}}/人（服务接收者）</span>
                            </span> </div>
                    </div>
